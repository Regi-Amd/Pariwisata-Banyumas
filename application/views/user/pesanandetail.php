<div class="rfm-container rfm-padding-32">
	...
	<div class="rfm-container rfm-center">
		...
		<a href="<?php echo base_url('pesananbatal/'.$isi_page['no_pemesanan']);?>" style='display: <?php echo $tmplButtn ?>;'>
			<button type="button" class="rfm-button rfm-red rfm-round-large rfm-hover-bayangan rfm-hover-red rfm-card-2">
				<b><i class="fa fa-ban"></i> BATAL</b>
			</button>
		</a>
	</div>
	<br>
